...
# ════════════════════════════════════════════════════════════════════════
# Конфиг — читает из config.json, токены берёт из переменных окружения
# ════════════════════════════════════════════════════════════════════════
 
def load_config():
    with open(CONFIG_PATH, encoding="utf-8") as f:
        cfg = json.load(f)
    # Railway передаёт токены через env-переменные — они в приоритете
...
def main():
    ...
    job()  # первый запуск сразу при старте
    while True:
